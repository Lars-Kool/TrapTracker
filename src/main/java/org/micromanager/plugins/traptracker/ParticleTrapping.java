...
public class ParticleTrapping implements SciJavaPlugin, MenuPlugin {
   ...
   public String getName() {
      return "ParticleTrapping";
   }

   @Override
   public String getHelpText() {
      return "User interface to (automatically) trap particles and perform analysis on each trap.";
   }
   ...
   public String getCopyright() {
      return "Institut Pierre-Gilles de Gennes, ESPCI, Paris, France, 2024-";
   }
}
